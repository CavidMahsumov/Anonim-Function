...
namespace Anonim_Function
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var deptoravarage = debtors.Average(d1 => d1.Debt);

            //var debtors1 = debtors
            //    .Where(d => d.Debt > deptoravarage)
            //    .OrderBy(d => d.FullName.Split(' ')[0])
            //    .ToList();

            //var debtors2 = debtors
            //   .Where(d => d.Debt > deptoravarage)
            //   .OrderByDescending(d => d.Debt)
            //   .ToList();
            //foreach (var item in debtors1)
            //{
            //    Console.WriteLine(item);
            //}
            //Console.WriteLine("Order By Descending Dept");
            ...
            //var debtpr = debtors
            //    .Where(d => Extetions.CheckPhoneNumber(d.Phone))
            //    .ToList();
            //foreach (var item in debtpr)
            //{
            //    Console.WriteLine(item);
            //}
            ...
            //    {
            //        var result =item.BirthDay.Subtract(DateTime.Now);
            //        Console.WriteLine();
            //    }
            //    return false;
